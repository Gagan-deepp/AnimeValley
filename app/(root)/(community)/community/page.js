...
const page = async ({ searchParams }) => {
  ...
  return (
    <div className='w-full md:w-[90%] mx-auto min-h-screen overflow-hidden sm:px-6 px-6 sm:pb-10 pt-5 max-md:pb-5 pb-10 '>
      <AddTalk />
      <div className="h-full flex flex-col overflow-hidden">
        <div className="flex gap-6 flex-1 overflow-hidden">
          ...
          <div className='flex-1 flex flex-col-reverse xl:flex-col h-full overflow-hidden'>
            ...
            <div>
              ...
              <div className="w-full bg-[#322d37a1] p-4 rounded-2xl relative flex-1 overflow-y-auto h-[80vh]"  >
