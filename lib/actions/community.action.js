...
export async function fetchCommunities({ searchText, pageNo, pageSize }) {
    try {
        ...
        const authorCreated = await userModel.find({ _id: communityQuery.createdBy })

        console.log("CreatedBy USer: ", authorCreated )
        ...
        return { allCommunities, isNext, authorCreated }
