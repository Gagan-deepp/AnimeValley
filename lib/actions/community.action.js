...
export async function deleteCommunity(communityID) {
    ...
    try {
        ...
        const deletedComm = await communityModel.findOne({ id: communityID })
        const deletedCommunity = await communityModel.findOneAndDelete({ id: communityID })

        console.log("deletedCommunity : ", deletedComm)
        if (!deletedCommunity) {
            throw new Error("Community not found");
        }

        console.log("deletedCommunityIDDDD : ", deletedComm._id)
        const communityUsers = await userModel.find({ communities: deletedComm._id });
